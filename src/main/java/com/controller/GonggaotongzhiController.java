...
public class GonggaotongzhiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,GonggaotongzhiEntity gonggaotongzhi, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,GonggaotongzhiEntity gonggaotongzhi, HttpServletRequest request){
        EntityWrapper<GonggaotongzhiEntity> ew = new EntityWrapper<GonggaotongzhiEntity>();
		PageUtils page = gonggaotongzhiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, gonggaotongzhi), params), params));
        return R.ok().put("data", page);
    }
